...
namespace BunchyAndroid.GcmService
{
	...
	public class PushHandlerBroadcastReceiver : GcmBroadcastReceiverBase<GcmService>
	{
		...
		public static string[] SENDER_IDS = new string[] { BunchyAndroid.Constant.Constant.SenderID };
	...
	public class GcmService : GcmServiceBase
	{
		...
		protected override async void OnRegistered (Context context, string registrationId)
		{
			...
			Hub = new NotificationHub(BunchyAndroid.Constant.Constant.NotificationHubPath, BunchyAndroid.Constant.Constant.ConnectionString);
			try
			{
		...
		void createNotification(string title, string desc)
		{
			...
			var notification = new Notification(BunchyAndroid.Resource.Drawable.bunchy, title);
